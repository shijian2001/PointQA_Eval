...
class BaseModel(nn.Module):
    ...
    @classmethod
    def init_pc_encoder(cls, precision, freeze, pc_encoder_ckpt_path=None):
        ...
        point_encoder.load_checkpoint(pc_encoder_ckpt_path or resolve_weight_path("pc_encoder", "point_model.pth"))
