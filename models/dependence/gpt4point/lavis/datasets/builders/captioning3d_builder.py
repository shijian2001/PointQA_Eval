...
from lavis.datasets.datasets.cap3d_captioning3d_dataset import (
    ...
    Cap3d_MultipleChoice_EvalDataset,
)
...
@registry.register_builder("cap3d_multiple_choice")
class Cap3d_MultipleChoice_Builder(BaseDatasetBuilder):
    train_dataset_cls = Cap3d_MultipleChoice_EvalDataset
    eval_dataset_cls = Cap3d_MultipleChoice_EvalDataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/cap3d/defaults_cap3d_multiple_choice.yaml",
    }
